const sitePages = [
    ...
    { title: 'Bento Gonçalves da Silva', url: 'paginas/personalidades/bento-goncalves.html', category: 'História', text: 'revolução farroupilha presidente república rio-grandense prisão fuga' },
    { title: 'Anita Garibaldi', url: 'paginas/personalidades/anita-garibaldi.html', category: 'História', text: 'revolucionária catarinense laguna giuseppe garibaldi guerra dos farrapos itália' },
    { title: 'Paixão Côrtes', url: 'paginas/personalidades/paixao-cortes.html', category: 'Cultura', text: 'tradicionalismo ctg manual de danças gaúchas semana farroupilha folclorista' },
    { title: 'Júlio de Castilhos', url: 'paginas/personalidades/julio-de-castilhos.html', category: 'História', text: 'castilhismo positivismo republicano governador primeira república' },
    { title: 'Barão de Mauá', url: 'paginas/personalidades/barao-de-maua.html', category: 'História', text: 'irineu evangelista de sousa ferrovia banco empresário arroio grande' },
    ...
    { title: 'Música Nativista', url: 'paginas/musica-danca/musica-nativista.html', category: 'Música', text: 'festivais, Califórnia da Canção Nativa, canção autoral e diferença com o tradicionalismo.' },
